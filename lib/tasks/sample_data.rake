...
def make_users
  admin = User.create!(name:     "RobertMarshall",
                       email:    "robert.marshallii1@gmail.com",
                       password: "password",
                       password_confirmation: "password")
  admin.toggle!(:admin)

  adminn = User.create!(name:     "weatherForecaster",
  ...
  99.times do |n|
    name  = "weatherForecaster#{n+1}"
    email = "example-#{n+1}@examplesite.com"
    password  = "password"
...
def make_stations
  Station.create!(identifier: "KBFI", city: "Seattle, WA", state: "WA", lat: "47.54", lon: "-122.3")
  Station.create!(identifier: "KPDX", city: "Portland, OR", state: "OR", lat: "45.58", lon: "-122.6")
  Station.create!(identifier: "KBDU", city: "Boulder, CO", state: "CO", lat: "40.039", lon: "-105.226")
  Station.create!(identifier: "KDEN", city: "Denver, CO", state: "CO", lat: "39.87", lon: "-104.67")
  Station.create!(identifier: "KMYP", city: "Monarch Pass, CO", state: "CO", lat: "38.497", lon: "-106.32")
end
